...
\begin{figure}[t]  
\centering
     \subfigure[]{\includegraphics[clip=true, trim= 1.0cm 1.0cm 3.25cm 3.25cm,width=0.98\linewidth]{./figures/bulbt/P/3m}} \\             
     \subfigure[]{\includegraphics[clip=true, trim= 1.0cm 1.0cm 3.25cm 3.25cm,width=0.98\linewidth]{./figures/bulbt/P/14m}} \\
     \subfigure[]{\includegraphics[clip=true, trim= 1.0cm 1.0cm 3.25cm 3.25cm,width=0.98\linewidth]{./figures/bulbt/P/50m}}     
